...
//                    return getHostUniqueFlavor();
    ...
    private String getPlatformFlavor() throws Exception {
        ...
        try {
            ...
            platformPcrs = getPcrList(hostInfo.getTpmVersion(), PLATFORM.getValue());
            includeEventLog = eventLogRequired(hostInfo.getTpmVersion(), PLATFORM.getValue());
            pcrDetails = PlatformFlavorUtil.getPcrDetails(hostManifest.getPcrManifest(), platformPcrs, includeEventLog);

            Flavor flavor = new Flavor(PlatformFlavorUtil.getMetaSectionDetails(hostInfo, tagCertificate, PLATFORM.getValue(), null), PlatformFlavorUtil.getHardwareSectionDetails(hostInfo),
                pcrDetails, null);
    ...
    private String getOsFlavor() throws Exception {
        ...
        try {
            ...
            osPcrs = getPcrList(hostInfo.getTpmVersion(), OS.getValue());
            includeEventLog = eventLogRequired(hostInfo.getTpmVersion(), OS.getValue());
            pcrDetails = PlatformFlavorUtil.getPcrDetails(hostManifest.getPcrManifest(), osPcrs, includeEventLog);

            Flavor flavor = new Flavor(PlatformFlavorUtil.getMetaSectionDetails(hostInfo, tagCertificate, OS.getValue(), null), null, pcrDetails, null);
    ...
    private String getAssetTagFlavor() throws PlatformFlavorException {
        ...
        try {
            ...
            Flavor flavor = new Flavor(PlatformFlavorUtil.getMetaSectionDetails(hostInfo, tagCertificate, ASSET_TAG.getValue(), null), null, null,
